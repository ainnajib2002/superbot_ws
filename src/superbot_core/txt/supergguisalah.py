...
root.geometry("1200x1000")  # Adjusted height to accommodate LoadcellApp lebar x tinggi
...
judul_label = tk.Label(root, text="Navigasi Robot Supermarket",
                       ...
                       bg="#f0f8ff", fg="#2f4f4f")
judul_label.pack(pady=(10, 5), padx=(0, 700))  # Adjusted padx to shift left

kategori_frame = tk.Frame(root, bg="#f0f8ff")
kategori_frame.pack(pady=(10, 5), padx=(0, 700)) 
...
label_daftar.pack(pady=(10, 5), padx=(0, 700)) 

listbox_goals = tk.Listbox(listbox_frame, width=40, height=8, font=("Arial", 10), justify="center")
listbox_goals.pack(pady=(10, 5), padx=(0, 700)) 

button_frame = tk.Frame(root, bg="#f0f8ff")
button_frame.pack(pady=(0, 8), padx=(0, 700))  # Adjusted padx to align with the title
...
status_label = tk.Label(root, text="Klik kategori untuk memulai navigasi.",
                        ...
                        bg="#f0f8ff", fg="green")
status_label.pack(pady=(0, 8), padx=(0, 700))  # Adjusted padx to align with the title
# -------------------------------
# LoadcellApp Class
# -------------------------------
class LoadcellApp:
    def __init__(self, root):
        ...
        self.title_label.pack(pady=(0, 150), padx=(700, 0))

        # Frame untuk tombol reset dan kalibrasi agar sejajar
        button_frame = tk.Frame(root, bg="#f0f8ff")
        button_frame.pack(pady=5, padx=(700, 0))  # Adjusted padx to align with title
        ...
        # Create a frame for weight and status to align with the reset button
        status_frame = tk.Frame(root, bg="#f0f8ff")
        status_frame.pack(pady=5, padx=(700, 0))  # Adjusted padx to align with title

        # LabelFrame for "Berat"
        berat_frame = tk.LabelFrame(status_frame, text="Berat", font=("Arial", 10, "bold"),
        ...
        self.weight_value_button.pack(padx=10, pady=10)

        # LabelFrame for "Status"
        status_label_frame = tk.LabelFrame(status_frame, text="Status", font=("Arial", 10, "bold"),
                                            bg="#f0f8ff", fg="#2f4f4f", labelanchor="n", padx=8, pady=4)
        status_label_frame.grid(row=0, column=1, padx=8, pady=8, sticky="n")
        ...
        self.status_value_button.pack(padx=10, pady=10)

        # Warning label
        self.warning_label = tk.Label(root, text="", font=("Helvetica", 14), bg="#f0f8ff", fg="green")
        self.warning_label.pack(pady=10, padx=(700, 0))  # Adjusted padx to align with title
