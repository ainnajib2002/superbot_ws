...
# -------------------------------
# Fungsi utilitas: urutkan berdasarkan jarak
# -------------------------------
...
# -------------------------------
# Kirim kategori ke daftar dan navigasi
# -------------------------------
...
btn_go = tk.Button(root, text="GO", width=18, font=("Arial", 11, "bold"),
                   bg="#32cd32", fg="white", padx=5, pady=5,
                   command=start_navigation)
btn_go.pack(pady=(5, 8))
